...
crawlDirectory(
    ...
    (filePath: string) => {
        ...
        // Check to see if the file is a .html file that contains a meta refresh tag.
        // If so, we'll configure the bucket object to be a website redirect so that
        // it returns a 301 response when requested.
...
// Returns the redirect URL if filePath is a .html file that contains a meta refresh tag, otherwise undefined.
